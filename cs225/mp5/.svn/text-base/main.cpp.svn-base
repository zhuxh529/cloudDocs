...
cout<< imgOut(0,0)->Red<<imgOut(0,1)->Red<<endl;
cout<< imgOut(1,0)->Red<<imgOut(1,1)->Red<<endl;
  ...
  cout << "fullTree.pruneSize(100000) = " <<
fullTree.pruneSize(100000) << endl;

  cout << "fullTree.idealPrune(1000) = "  << fullTree.idealPrune(1000) << endl;
  cout << "fullTree.idealPrune(10000) = " <<
fullTree.idealPrune(10000) << endl;
