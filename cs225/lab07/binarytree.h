...
class BinaryTree
{
	...
	bool isOrdered() const;
		queue<T> Ordered(const Node * subroot) const ;
   void ordersup();
	void printPaths() const;
   void printPaths(const Node * subroot, T path[], int l) const;
	int  sumDistances() const;
		void sumDistances(const Node * subroot, int l,int dis, stack<int> &K) const;
